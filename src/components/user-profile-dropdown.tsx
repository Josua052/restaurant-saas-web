  ...
  return (
    <div className="relative ml-2">
      ...
      <button 
        ...
        className="w-9 h-9 rounded-full bg-slate-200 border border-slate-300 overflow-hidden hover:ring-2 hover:ring-indigo-500 hover:ring-offset-2 transition-all cursor-pointer focus:outline-none"
      >
