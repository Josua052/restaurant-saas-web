...
import { ChevronRight, Info, CloudUpload, Archive } from "lucide-react";
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-lg font-medium text-sm flex items-center gap-2 transition-colors shadow-sm">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <select className="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors bg-white cursor-pointer">
                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="0"
                      className="w-full pl-12 pr-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-colors resize-none"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            ...
            <div className="p-4 border border-slate-200 rounded-lg flex items-center justify-between">
              ...
              <button
                ...
                className={`w-11 h-6 rounded-full flex items-center transition-colors px-1 ${isAvailable ? "bg-indigo-600" : "bg-slate-300"}`}
              >
                <div
