      ...
      <div className="bg-white rounded-2xl w-full max-w-4xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex flex-col md:flex-row flex-1 overflow-y-auto">
          ...
          <div className="flex-[1.2] p-6">
            <h4 className="font-semibold text-slate-800 text-xs tracking-wider uppercase mb-5">
              ...
              {[
                {
                  id: "Tunai",
                  label: "Tunai",
                  icon: <Banknote className="w-5 h-5 mb-2 mx-auto" />,
                },
                {
                  id: "Debit BCA",
                  label: "Debit BCA",
                  icon: <CreditCard className="w-5 h-5 mb-2 mx-auto" />,
                },
                {
                  id: "QRIS",
                  label: "QRIS",
                  icon: <QrCode className="w-5 h-5 mb-2 mx-auto" />,
                },
                {
                  id: "Kartu Kredit",
                  label: "Kartu Kredit",
            ...
            {paymentMethod === "Tunai" && (
              <div className="mb-8">
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-center">
                  <span className="block text-emerald-600 text-xs font-bold tracking-wider uppercase mb-1">
                    Kembalian
                  </span>
        ...
        <div className="p-5 bg-white border-t border-slate-100 flex gap-3 justify-end shrink-0">
          ...
          <button
            disabled={
              isSubmitting ||
              (paymentMethod === "Tunai" && cashVal < grandTotal)
            }
