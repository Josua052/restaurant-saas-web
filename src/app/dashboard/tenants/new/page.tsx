    ...
    <div className="space-y-6">
      ...
      <div className="pb-12">
        <div className="w-full">
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-2xl md:text-[28px] font-bold text-slate-900 font-heading mb-2">
              Register New Restaurant
            </h1>
            <p className="text-sm md:text-[15px] text-slate-500">
              Create a new tenant account and configure initial owner access.
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm flex flex-col">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2.5">
                        <label
                          htmlFor="ownerEmail"
                          className={`text-[13px] font-semibold block ${showEmailError ? "text-red-600" : "text-slate-700"}`}
                        >
                        ...
                        <div className="relative">
                          ...
                          />
                          <div
                            className={`absolute left-3.5 top-1/2 -translate-y-1/2 ${showEmailError ? "text-red-500" : "text-slate-400"}`}
                          >
                            <svg
                        ...
                        {showEmailError && (
                          <p className="text-[11px] md:text-xs font-semibold text-red-600 mt-1.5 flex items-center gap-1">
                            <AlertCircle className="h-3.5 w-3.5" /> Please enter
                      ...
                      <div className="space-y-2.5">
                        ...
                        <div className="relative">
                          ...
                          />
                          <div
                            className={`absolute left-3.5 top-1/2 -translate-y-1/2 ${showPasswordSuccess ? "text-green-500" : "text-slate-400"}`}
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
                        ...
                        {showPasswordSuccess ? (
                          <p className="text-[11px] md:text-xs font-semibold text-green-600 mt-1.5 flex items-center gap-1">
                            <CheckCircle2 className="h-3.5 w-3.5" /> Minimum 6
                            characters
                          </p>
                        ) : (
              ...
              <div className="bg-slate-50 border-t border-slate-200 p-6 flex flex-col-reverse md:flex-row md:items-center justify-between gap-4">
                <Button
                  ...
                  className="text-slate-600 hover:text-slate-900 font-medium px-0 hover:bg-transparent"
                >
      ...
      <Dialog open={showConfirmModal} onOpenChange={setShowConfirmModal}>
        <DialogContent className="sm:max-w-[460px] p-0 overflow-hidden gap-0">
          <DialogHeader className="p-6 pb-4">
            <DialogTitle className="text-lg md:text-xl font-bold font-heading text-slate-900">
              Confirm Restaurant Registration
            </DialogTitle>
            <DialogDescription className="text-sm text-slate-500 mt-1">
              Please review the details below. The owner will use this email and
              password to log in.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="px-6 pb-2">
            <div className="border border-slate-200 rounded-lg overflow-hidden mb-4">
              <div className="grid grid-cols-[140px_1fr] items-center p-3.5 border-b border-slate-200 text-[13px]">
                ...
                <span className="text-slate-900 font-medium text-right">
                  {restaurantName || "The Rustic Spoke"}
                </span>
              </div>
              <div className="grid grid-cols-[140px_1fr] items-center p-3.5 border-b border-slate-200 text-[13px]">
                <span className="font-semibold text-slate-500 text-[11px] tracking-wider uppercase">
              ...
              <div className="grid grid-cols-[140px_1fr] items-center p-3.5 text-[13px]">
                ...
                <div className="flex items-center justify-end gap-3">
                  <span
                    className={`text-slate-900 font-medium ${!showPasswordModal ? "tracking-widest text-base translate-y-[2px]" : "text-[13px]"}`}
                  >
            ...
            <div className="bg-[#eff2ff] rounded-lg border border-[#e0e7ff] p-3.5 flex gap-3">
              ...
              <p className="text-[13px] text-indigo-900/80 leading-snug">
                Make sure the email and password are correct — the owner will
                need them to access their dashboard.
              </p>
            </div>
          </div>
          ...
          <DialogFooter className="p-6 bg-white flex flex-row items-center justify-between sm:justify-between border-t border-slate-100 gap-2 mt-2">
            <Button
              ...
              className="w-full sm:w-auto h-10 border-slate-300 text-slate-700 font-medium"
            >
              Edit Details
            </Button>
            <Button
              ...
              className="w-full sm:w-auto h-10 bg-indigo-600 hover:bg-indigo-700 text-white font-medium"
            >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-[360px] w-full p-8 text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-slate-500 text-[14px] mb-6 leading-relaxed">
              The new restaurant has been successfully registered on the
              platform.
            </p>
            ...
            <Button
              onClick={() => router.push("/dashboard/tenants")}
              className="w-full bg-indigo-600 hover:bg-indigo-700 h-11 text-[15px] font-medium rounded-lg"
            >
              Go to Tenants List
